...
ENCODER_MAGNET_OFFSETS = [1733.0 / 4096, -986.0 / 4096, 1860.0 / 4096, 1443.0 / 4096]  # TODO
...
# Cameras
BASE_CAMERA_SERIAL = '881237AE'
WRIST_CAMERA_SERIAL = 'AE8035BE'  # Not used by Kinova wrist camera

# Policy
POLICY_SERVER_HOST = 'localhost'
POLICY_SERVER_PORT = 5555
POLICY_CONTROL_FREQ = 10.0
